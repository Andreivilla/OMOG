...
#print('pontosControleNurbs[2][1]: {}\n - pontosControleNurbs[1][1]: {}\n, pontosControleNurbs[2][0]: {}\n - pontosControleNurbs[1][0]: {}\n'.format(pontosControleNurbs[2][1], pontosControleNurbs[1][1], pontosControleNurbs[2][0], pontosControleNurbs[1][0]))
...
#print('pontosControleBezier[3]: {}\n = pontosControleNurbs[2]: {}\n + np.array([comprimento * np.cos(angulo_PN2): , comprimento * np.sin(angulo_PN2): ]){}\n'.format#(pontosControleBezier[3], pontosControleNurbs[2], np.array([comprimento * np.cos(angulo_PN2), comprimento * np.sin(angulo_PN2)])))

pontosControleBezier[3] = pontosControleNurbs[2] + np.array([comprimento * np.cos(angulo_PN2), comprimento * np.sin(angulo_PN2)])

#print('bezier[3] = {}'.format(pontosControleBezier[3]))
...
while bezier:
    ...
    for i, ponto in enumerate(pontosControleBezier_scaled):
        ...
        text = pygame.font.SysFont('Arial', 12).render(f'PB{i+1} {ponto[0]},{ponto[1]}', True, GREEN)
    ...
    for i, ponto in enumerate(pontosControleNurbs_scaled):
        ...
        text = pygame.font.SysFont('Arial', 12).render(f'PN{i+1} {ponto[0]},{ponto[1]}', True, BLUE)
    ...
    #presta atenção em mimaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
